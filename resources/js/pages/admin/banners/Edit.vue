...
const form = useForm({
  ...
  start_date: props.banner.start_date ? props.banner.start_date.slice(0, 16) : '',
  end_date: props.banner.end_date ? props.banner.end_date.slice(0, 16) : '',
  _method: 'PUT',
});

const imagePreview = ref<string | null>(props.banner.image_url);
...
const breadcrumbs = [
  ...
  { title: 'Chỉnh sửa Banner', href: `/admin/banners/${props.banner.id}/edit` }
];
</script>
          ...
          <div class="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Cập nhật thông tin chi tiết cho banner</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload hình ảnh mới hoặc giữ nguyên hình ảnh hiện tại</CardDescription>
              </CardHeader>
              <CardContent class="space-y-4">
                <div class="space-y-2">
                  ...
                  <p class="text-sm text-muted-foreground">Để trống nếu không muốn thay đổi hình ảnh</p>
                </div>
            ...
            <Card>
              <CardContent class="pt-6">
                ...
                >
                  ...
                  {{ form.processing ? 'Đang lưu...' : 'Cập nhật Banner' }}
                </Button>
              </CardContent>
            </Card>
          </div>
