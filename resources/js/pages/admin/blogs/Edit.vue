...
const form = useForm({
    ...
    published_at: props.blog.published_at
        ? new Date(props.blog.published_at)
              .toISOString()
              .slice(0, 16)
        : '',
...
const imagePreview = ref<string | null>(props.blog.featured_image || null);
...
function submit() {
    // Add method spoofing for PUT with file upload
    form.transform((data) => {
        return {
            ...data,
            _method: 'PUT',
...
const breadcrumbs = [
    ...
    { title: 'Chỉnh sửa bài viết', href: `/admin/blogs/${props.blog.id}/edit` },
];
</script>
                        ...
                        <Card>
                            ...
                            <CardContent class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <!-- Change Image Button (if existing image) -->
                                    <div
                                        v-if="form.featured_image && !imagePreview"
                                        class="mt-4"
                                    >
                                        <label
                                            for="featured_image_file_change"
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="flex gap-2">
                            ...
                            >
                                ...
                                {{ form.processing ? 'Đang lưu...' : 'Cập nhật bài viết' }}
                            </Button>
                        </div>
                    </div>
                </div>
