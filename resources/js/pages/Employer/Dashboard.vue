      ...
      <div class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
        <div class="container mx-auto px-4 py-6">
          <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <Link
              :href="route('employer.postings.create')"
          ...
          <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                ...
                <Link :href="route('employer.postings.index')" class="text-sm font-medium text-blue-600 hover:text-blue-700 flex items-center gap-1">
                  ...
                  <tbody class="divide-y divide-gray-100">
                    ...
                    <tr v-if="!recentJobs.length">
                      <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                        ...
                        <Link :href="route('employer.postings.create')" class="text-blue-600 font-medium hover:underline ml-1">Đăng tin ngay</Link>
                      </td>
                    </tr>
                  </tbody>
                </table>
