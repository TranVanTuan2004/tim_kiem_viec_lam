                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="border-b border-gray-200 p-6">
                        ...
                        <p class="mt-2 text-gray-600">
                            Cập nhật thông tin về học vấn của bạn
                        </p>
                    </div>
...
const form = useForm({
    ...
    is_current: !props.education.end_date, // Compute from end_date
});
...
const submit = () => {
    form.transform((data) => {
        ...
        return transformed;
    }).put(update(props.education.id).url(), {
        preserveScroll: true,
    });
};
</script>
