    ...
    public function run(): void
    {
        ...
        $companies = [
            [
                ...
                'logo' => null, // Frontend will generate default logo
                'city' => 'Hà Nội',
                'province' => 'Hà Nội',
            ...
            [
                'company_slug' => 'viettel-solutions',
                'company_name' => 'Viettel Solutions',
                'description' => 'Thành viên của Tập đoàn Công nghiệp - Viễn thông Quân đội, cung cấp các giải pháp CNTT & Viễn thông hàng đầu.',
                'website' => 'https://solutions.viettel.vn',
                'logo' => null,
                'city' => 'Hà Nội',
                'province' => 'Hà Nội',
                'address' => 'Tòa nhà Viettel, Số 1 Trần Hữu Dực, Nam Từ Liêm, Hà Nội',
                'size' => '1000+',
            ...
            [
                'company_slug' => 'nashtech-vietnam',
                'company_name' => 'NashTech Vietnam',
                'description' => 'Công ty công nghệ toàn cầu, cung cấp các giải pháp phần mềm, tư vấn công nghệ và dịch vụ BPO.',
                'website' => 'https://nashtechglobal.com',
                'logo' => null,
                'city' => 'TP.HCM',
                'province' => 'TP.HCM',
                'address' => '364 Cộng Hòa, Tân Bình, TP.HCM',
                'size' => '1000+',
                'industry' => 'Software',
                'rating' => 4.2,
                'total_reviews' => 450,
